        ...
        <div data-v-67ef3a4a class="layout clear">
            <div data-v-67ef3a4a class="left csdnav" id="daohang">
                <label data-v-67ef3a4a v-if="weidenglu">
                    ...
                    <a data-v-67ef3a4a href="${pageContext.request.contextPath}/user/add" class="colorRed" style="margin-right: 10px;">注册</a>
                </label>

                <label data-v-67ef3a4a v-if="denglu">
                    <a data-v-67ef3a4a href="#">你好，</a>
                    <a data-v-67ef3a4a href="#" class="colorRed">/</a>
                    <a data-v-67ef3a4a href=${pageContext.request.contextPath}/user/index class="colorRed" style="margin-right: 10px;">[退出]</a>
                </label>
        ...
        <div data-v-39f7f629="" class="layout clear">
            ...
            <div data-v-39f7f629="" class="left navCom">
                <ul data-v-39f7f629="">
                    ...
                    <li data-v-39f7f629="">
                        <a data-v-39f7f629="" href="${pageContext.request.contextPath}/shortRent/shortrent.jsp" target="_self" class="colorRed">短租自驾</a>
                    </li>
                    <li data-v-39f7f629="">
                        <a data-v-39f7f629="" href="${pageContext.request.contextPath}/page/index.jsp" target="_self" >
...
<script type="text/javascript">
    ...
    function loadfirst(pid){
        $.ajax({
            type:"post",
            url:"${pageContext.request.contextPath}/city/select?pid="+pid,
            dataType:"json",
...
<script type="text/javascript">
    ...
    function selectCar() {
        var getid = $("#bmsel").val();
        var backid = $("#hcs").val();
        window.location.href="${pageContext.request.contextPath}/shortRent/shortsort.jsp?getid="+getid+"&backid="+backid;
