...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/shortrent.shortrent.css">
    ...
    <div data-v-67ef3a4a class="layout clear">
        <div data-v-67ef3a4a class="left csdnav">
            <label data-v-67ef3a4a>
                <a data-v-67ef3a4a href="${pageContext.request.contextPath}/page/login.jsp" class="colorRed">登录</a>
                <a data-v-67ef3a4a href="" class="colorRed">/</a>
                <a data-v-67ef3a4a href="${pageContext.request.contextPath}/page/register.jsp" class="colorRed" style="margin-right: 10px;">注册</a>
            </label>
                ...
                <div class="item clear" id="carlist">
                    <div class="thisPlace clear" id="carli" v-for="site in sites">
                        ...
                        <div class="itemCarMsg left" >
                            ...
                            <p id="sitetype">{{site.type}}</p><p id="sitNum">{{site.sitNum}}座</p>
                        </div>
   ...
   var vm2 = new Vue({
       ...
       methods:{
         selectCar:function (id) {
             window.location.href="${pageContext.request.contextPath}/car/orderSum"+getid +"&cid=" +id;
         }
       },
...
<script type="text/javascript">
    $(function(){
        ...
        $.ajax({
        type:"get",
        url:"${pageContext.request.contextPath}/city/gbCity"+getid,
            dataType:"json",
