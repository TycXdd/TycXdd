...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/order.ordersubmit.css">
        ...
        <div data-v-95ac8d30="" class="layout clear">
            ...
            <div data-v-95ac8d30="" class="header3Nav right">|<a data-v-95ac8d30=""
                    ...
                    data-v-95ac8d30="" href="helpCenter.html">帮助中心</a>|<a data-v-95ac8d30=""
                                                                          href="${pageContext.request.contextPath}/order/loginOut">退出</a></div>
...
<script type="text/javascript">
    ...
    function submitorder() {
        ...
        $.ajax({
            ...
            success: function (data) {
                alert(data.info);
                window.location.href = "${pageContext.request.contextPath}/myMain/mymain.jsp";
            },
            error: function () {
                alert("ajax加载失败");
            }
