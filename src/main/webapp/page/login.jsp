...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/pagehome.login.css">
...
<div data-v-0a99943a id="app">
    ...
    <div data-v-95c8bc32="" class="layout clear">
        ...
        <a data-v-95c8bc32="" href="${pageContext.request.contextPath}/page/index.jsp" class="right">回到首页&gt;</a>
    </div>
    </div>
        ...
        <div data-v-0a99943a="" class="layout">
            <div data-v-0a99943a="" class="loginCom clear">
                ...
                <div data-v-0a99943a="" class="loginType right">
                    ...
                    <div class="forms">
                        <form class="layui-form" method="post" action="${pageContext.request.contextPath}/user/login">
...
<%--                                ${msg}--%>
                            ...
                            <div data-v-0a99943a="" class="goRegister">
                                还没有账号？<a data-v-0a99943a="" href="${pageContext.request.contextPath}/page/register.jsp">免费注册</a></div>
                        </form>
                    </div>
                </div>
            </div>
